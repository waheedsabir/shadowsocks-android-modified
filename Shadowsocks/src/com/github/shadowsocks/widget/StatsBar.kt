...
class StatsBar @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = R.attr.bottomAppBarStyle) :
    ...
    fun changeState(state: BaseService.State) {
        ...
        if ((state == BaseService.State.Connected).also { hideOnScroll = it }) {
            ...
            tester.status.observe(activity) {
                it.retrieve(this::setStatus) { msg -> activity.snackbar(msg).show() }
            }
        } else {
